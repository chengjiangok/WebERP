/*
 * @Author: ChengJiang 
 * @Date: 2017-03-04 06:09:38 
 * @Last Modified by: ChengJiang
 * @Last Modified time: 2017-03-04 06:30:45
 */

<?php
/* $Id: CustomerReceipt.php $*/

include('includes/session.php');
$Title = '客户交易对账';// Screen identification.
...
echo '<p class="page_title_text">
		<img src="', $RootPath, '/css/', $Theme, '/images/customer.png" title="', _('Customer'), '" alt="" />', _('Customer'), ': ', stripslashes($CustomerID), ' - ', $CustomerRecord['name'], '<br />', _('All amounts stated in'), ': ', $CustomerRecord['currency'], '<br /></p>';
		//, _('Terms'), ': ', $CustomerRecord['terms'], '<br />', _('Credit Limit'), ': ', locale_number_format($CustomerRecord['creditlimit'], 0), '<br />', _('Credit Status'), ': ', $CustomerRecord['reasondescription'], '
