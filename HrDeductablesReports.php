  ...
  else if(isset($_POST['ShowHtml']))
  {
    ...
    else if($_POST['DetailOrSummary'] == 'Detail')
    {
      ...
      while($myrow = DB_fetch_array($result))
      {
        ...
        $sql2 = "SELECT hrpayslipcategorydetails.* ,payroll_category_code,payroll_category_name,payroll_category_type 
                        from hrpayslipcategorydetails
                         JOIN hrpayrollcategories ON hrpayslipcategorydetails.payroll_category_id = hrpayrollcategories.payroll_category_id
