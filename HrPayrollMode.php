...
/* $Id: HrPayrollMode.php  $ */
/*	Add and Edit Employee*/

include('includes/session.php');
$Title = '工资构成设置';//_('Generate Payroll for Paygroups');
...
if (! isset($_GET['delete'])) {
	...
	echo '<tr>
        ...
        echo '<tr>
                 <td><label for="PaymentFrequency">工资计算周期:</label></td>
                 <td><select id="PaymentFrequency" name="PaymentFrequency" >';
		...
		echo'<tr>
			...
			<tr>
			    <td><label for="EnableLop">是否核算工资(LOP):</label></td>
			    <td><input type="radio"';
			if (isset($_POST['EnableLop']) and $_POST['EnableLop']==1) {
			    echo ' checked';}
			    echo'name="EnableLop" id ="EnableLop" value="1">Yes
			         <input';
						if (! isset($SelectedGroupName)) {
						echo ' checked';
						}
						...
						echo'type="radio" name="EnableLop"  id ="EnableLop" value="0"> No</td>
					</tr>
					<tr>
						<td>' . _('LOP Value') . ':</td>
						<td><input type="text" id="LopValue" name="LopValue"  value="' . $_POST['LopValue'] . '" /></td>
					...
					echo '<tr>
							 <td><label for="PayrollCategories">' . _('Payroll Categories') .':</label></td>
							 <td>
							    <select id="PayrollCategories" name="PayrollCategories[]" multiple="multiple" >';
					...
					// Bank Accounts.
					echo '<tr> 
					          <td><label for="BankAccount">' . _('Bank Account') .':</label></td><td><select id="BankAccount" name="BankAccount" >';
					...
					// General Legder  input.
					echo '<tr>
							  <td><label for="GeneralLegder">' . _('General Legder Posting Account') .		':</label></td>
							  <td><select id="GeneralLegder" name="GeneralLegder" >';
