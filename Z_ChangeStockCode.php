...
<?php
/*	$Id: Z_ChangeStockCode.php $*/
/*
 * @Author: ChengJiang 
 * @Date: 2019-08-09 13:26:24 
 * @Last Modified by:   mikey.zhaopeng 
 * @Last Modified time: 2019-08-09 13:26:24 
 */
...
/*Now check that the new code doesn't already exist */
	...
	if ($InputError ==0){ // no input errors
		...
		//国经纬
		ChangeFieldInTable("suppaccount", "stockid", $_POST['OldStockID'], $_POST['NewStockID'], $db);
		ChangeFieldInTable("custaccount", "stockid", $_POST['OldStockID'], $_POST['NewStockID'], $db);
