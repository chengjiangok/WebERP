...
$SQL="SELECT `code`,  `subcategoryid` categoryid, `subcategorydspn` categorydescription, `flg` FROM `stocksubcategory` WHERE `stocktype`='F' AND LEFT(`categoryid`,1)=1";
...
echo '</td></tr></table>';
	...
	echo '<a href="' . $RootPath . '/Components.php?">' . _('Insert New Item') . '</a><br />';
	echo '</td></tr></table>';
