...
$Title ='员工休假类型';// _('Employment Leave Types');
		...
		<tr>
			...
			echo'
			  ...
			  type="radio" name="Status" value="0"> Inactive
				...
				<tr><td><label for="LeaveBalance">休假余额:</label></td>
					<td><input type="radio"';
					if (! isset($SelectedName)) {
					 echo ' checked';}
					if (isset($_POST['LeaveBalance']) and $_POST['LeaveBalance']==1) {
						echo ' checked';}
				echo'
					 name="LeaveBalance" value="1"> 允许结转
				...
				echo'
type="radio" name="LeaveBalance" value="0">不允许结转
					</td></tr>

					<tr><td><label for="Salarydeduction">休假工资计算:</label></td>
						<td><input type="radio"';
						if (! isset($SelectedName)) {
						 echo ' checked';}
						if (isset($_POST['Salarydeduction']) and $_POST['Salarydeduction']==1) {
							echo ' checked';}
					echo'
						 name="Salarydeduction" value="1">扣工资 (LOP)
						<input';
						if (isset($_POST['Salarydeduction']) and $_POST['Salarydeduction']==0) {
							echo ' checked';
						}
					echo'
					type="radio" name="Salarydeduction" value="0">不扣工资
						</td></tr>
						<tr>
