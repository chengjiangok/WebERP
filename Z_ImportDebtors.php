...
if (isset($_FILES['userfile']) and $_FILES['userfile']['name']) { //start file processing
 ...
 $STR='';
	while ( ($filerow = fgetcsv($FileHandle,  ",")) !== FALSE ) {
		...
		$_POST['CustName']=iconv('GB2312', 'UTF-8',$filerow[1]);
		$_POST['Address1']=iconv('GB2312', 'UTF-8',$filerow[2]);
		$_POST['Address2']=iconv('GB2312', 'UTF-8',$filerow[3]);
		$_POST['Address3']=iconv('GB2312', 'UTF-8',$filerow[4]);
		$_POST['Address4']=iconv('GB2312', 'UTF-8',$filerow[5]);
		$_POST['Address5']=iconv('GB2312', 'UTF-8',$filerow[6]);
		$_POST['Address6']=iconv('GB2312', 'UTF-8',$filerow[7]);
	...
	$_POST['AddrInvBranch']	=$filerow[18];//$_POST['InvAddrBranch']
		...
		if($filerow[18]==''){
$STR=$STR.$filerow[16].''.$filerow[17].'-'.$filerow[18].'-'.$filerow[19].'='.$row;
prnMsg($STR,'info');
}
		if ($_POST['AutoDebtorNo']== 1) {
