...
if(isset($_POST['SelectedTaxAuthID'])) {
   ...
   $TaxType=array("0"=>"其他","1"=>"销售","2"=>"采购","3"=>"销售采购");
...
if(isset($SelectedTaxAuthID)) {
	...
	$_POST['BankAccType']	= $myrow['onorder'];
...
$SQL = "SELECT accountcode,
		...
		WHERE accountgroups.pandl=0 AND accountcode LIKE '2221_%'
...
echo '</select></td>
	...
	<tr>
		<td>税率%:</td>
		<td><input type="text" name="TaxRate" size="5" maxlength="7" value="' . $_POST['TaxRate'] . '" placeholder="请输入小数如0.09" /></td>
	</tr>
	<tr>
	<td>订单计算:</td>
	<td><input type="radio" name="OnOrder" value="3"  '.($_POST['OnOrder']==3?"checked":"").' />采购销售
	<input type="radio" name="OnOrder" value="1"  '.($_POST['OnOrder']==1?"checked":"").' />销售
	<input type="radio" name="OnOrder" value="2"  '.($_POST['OnOrder']==2?"checked":"").' />采购
	<input type="radio" name="OnOrder" value="0"  '.($_POST['OnOrder']==1?"checked":"").' />其他</td>
</tr>
	</table>';
	echo $_POST['OnOrder'];
echo '<br />
